...
public class ForecastRecyclerViewAdapter extends RecyclerView.Adapter<ForecastRecyclerViewAdapter.MyViewHolder> {
    ...
    public ForecastRecyclerViewAdapter(JSONArray weatherData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        try {
            ...
            holder.tv_temp.setText(String.format(Locale.getDefault(), "%.0f %s", data.getDouble("temp"), Html.fromHtml("&#8451;")));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_details = itemView.findViewById(R.id.tv_detail);
